...
all: build/htlc build/secp256k1_blake2b_sighash_all_lib.so build/or build/simple_udt build/secp256k1_blake2b_sighash_all_dual build/and build/open_transaction build/rsa_sighash_all blst-demo deps/libecc build/secp256r1_blake160_sighash_all build/secp256r1_blake160_sighash_bench
...
clean:
	...
	rm -rf build/secp256r1_blake160_c* build/secp256r1_blake160_sighash_all build/secp256r1_blake160_sighash_bench
